...
todos = [
    {'id': todo_1_id, 'name': 'Milch', 'description': 'Du musst noch dein Milch kaufen! Sonst hast du kein Milch für deine Kaffee.', 'list': todo_list_1_id},
    {'id': todo_2_id, 'name': 'Arbeitsblätter ausdrucken', 'description': 'Du musst die Blätter ausdrucken sonst hast du Stress in der Schule', 'list': todo_list_2_id},
